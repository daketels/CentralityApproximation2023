...
for i in range(1,21):
    ba_uniform_mc_file = open("./" + prefix_mc + "/G_ba_uniform_{}.out".format(i))
    ba_uniform_mc_vals = ba_uniform_mc_file.readlines()[1]


    ba_uniform_phi_file = open("./" + prefix_phi + "/G_ba_uniform_{}.out".format(i))
    ba_uniform_phi_lines = ba_uniform_phi_file.readlines()
    ba_uniform_phi_vals = ba_uniform_phi_lines[0]

    run_0_1 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0

    ba_uniform_mc_file.close()
    ba_uniform_phi_file.close()

    ba_uniform_mc_vals = ba_uniform_mc_vals.split(",")
    ba_uniform_phi_vals = ba_uniform_phi_vals.split(",")

    ba_uniform_mc_vals = [float(elem) for elem in ba_uniform_mc_vals]
    ba_uniform_phi_vals = [float(elem) for elem in ba_uniform_phi_vals]

    acc_error = 0.0

    for j in range(500):
        error = abs(ba_uniform_mc_vals[j]-ba_uniform_phi_vals[j])
        avg_ae_0_1 += error / 500.0
        acc_error += error / 500.0

    max_ae_0_1 = max(max_ae_0_1, acc_error)

    L_mc = [(ba_uniform_mc_vals[j], j+1) for j in range(500)]
    L_psp = [(ba_uniform_phi_vals[j], j+1) for j in range(500)]
    ...
    #print("for G_ba_uniform_{}".format(i) + ", phi = 0.1:\n")
...
for i in range(1,21):
    ...
    run_0_2 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_3 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_4 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_5 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_6 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_7 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_8 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_9 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_1_0 += float(ba_uniform_phi_lines[3].split()[1]) / 20.0
...
f.savefig("./plots/phi_ba_uniform/phi_avg_runtime_ba_uniform.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_ba_uniform/phi_avg_mae_ba_uniform.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_ba_uniform/phi_max_mae_ba_uniform.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_ba_uniform/phi_avg_scc_ba_uniform.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_ba_uniform/phi_max_scc_ba_uniform.pdf")
plt.close()
