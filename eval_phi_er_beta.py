...
for i in range(1,21):
    er_beta_mc_file = open("./" + prefix_mc + "/G_er_beta_{}.out".format(i))
    er_beta_mc_vals = er_beta_mc_file.readlines()[1]


    er_beta_phi_file = open("./" + prefix_phi + "/G_er_beta_{}.out".format(i))
    er_beta_phi_lines = er_beta_phi_file.readlines()
    er_beta_phi_vals = er_beta_phi_lines[0]

    run_0_1 += float(er_beta_phi_lines[3].split()[1]) / 20.0

    er_beta_mc_file.close()
    er_beta_phi_file.close()

    er_beta_mc_vals = er_beta_mc_vals.split(",")
    er_beta_phi_vals = er_beta_phi_vals.split(",")

    er_beta_mc_vals = [float(elem) for elem in er_beta_mc_vals]
    er_beta_phi_vals = [float(elem) for elem in er_beta_phi_vals]

    acc_error = 0.0

    for j in range(500):
        error = abs(er_beta_mc_vals[j]-er_beta_phi_vals[j])
        avg_ae_0_1 += error / 500.0
        acc_error += error / 500.0

    max_ae_0_1 = max(max_ae_0_1, acc_error)

    L_mc = [(er_beta_mc_vals[j], j+1) for j in range(500)]
    L_psp = [(er_beta_phi_vals[j], j+1) for j in range(500)]
    ...
    #print("for G_er_beta_{}".format(i) + ", phi = 0.1:\n")
...
for i in range(1,21):
    ...
    run_0_2 += float(er_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_3 += float(er_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_4 += float(er_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_5 += float(er_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_6 += float(er_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_7 += float(er_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_8 += float(er_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_9 += float(er_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_1_0 += float(er_beta_phi_lines[3].split()[1]) / 20.0
...
f.savefig("./plots/phi_er_beta/phi_avg_runtime_er_beta.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_er_beta/phi_avg_mae_er_beta.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_er_beta/phi_max_mae_er_beta.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_er_beta/phi_avg_scc_er_beta.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_er_beta/phi_max_scc_er_beta.pdf")
plt.close()
