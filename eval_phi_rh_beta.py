...
for i in range(1,21):
    rh_beta_mc_file = open("./" + prefix_mc + "/G_rh_beta_{}.out".format(i))
    rh_beta_mc_vals = rh_beta_mc_file.readlines()[1]


    rh_beta_phi_file = open("./" + prefix_phi + "/G_rh_beta_{}.out".format(i))
    rh_beta_phi_lines = rh_beta_phi_file.readlines()
    rh_beta_phi_vals = rh_beta_phi_lines[0]

    run_0_1 += float(rh_beta_phi_lines[3].split()[1]) / 20.0

    rh_beta_mc_file.close()
    rh_beta_phi_file.close()

    rh_beta_mc_vals = rh_beta_mc_vals.split(",")
    rh_beta_phi_vals = rh_beta_phi_vals.split(",")

    rh_beta_mc_vals = [float(elem) for elem in rh_beta_mc_vals]
    rh_beta_phi_vals = [float(elem) for elem in rh_beta_phi_vals]

    acc_rhror = 0.0

    for j in range(500):
        rhror = abs(rh_beta_mc_vals[j]-rh_beta_phi_vals[j])
        avg_ae_0_1 += rhror / 500.0
        acc_rhror += rhror / 500.0

    max_ae_0_1 = max(max_ae_0_1, acc_rhror)

    L_mc = [(rh_beta_mc_vals[j], j+1) for j in range(500)]
    L_psp = [(rh_beta_phi_vals[j], j+1) for j in range(500)]
    ...
    #print("for G_rh_beta_{}".format(i) + ", phi = 0.1:\n")
...
for i in range(1,21):
    ...
    run_0_2 += float(rh_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_3 += float(rh_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_4 += float(rh_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_5 += float(rh_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_6 += float(rh_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_7 += float(rh_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_8 += float(rh_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_0_9 += float(rh_beta_phi_lines[3].split()[1]) / 20.0
...
for i in range(1,21):
    ...
    run_1_0 += float(rh_beta_phi_lines[3].split()[1]) / 20.0
...
f.savefig("./plots/phi_rh_beta/phi_avg_runtime_rh_beta.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_rh_beta/phi_avg_mae_rh_beta.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_rh_beta/phi_max_mae_rh_beta.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_rh_beta/phi_avg_scc_rh_beta.pdf")
plt.close()
...
plt.xlabel(r"$\phi$", size = 18)
plt.bar(x,y, width=0.3)
f.savefig("./plots/phi_rh_beta/phi_max_scc_rh_beta.pdf")
plt.close()
